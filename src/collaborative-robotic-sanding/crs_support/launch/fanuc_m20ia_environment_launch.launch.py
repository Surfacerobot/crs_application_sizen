...
def launch_setup(context, *args, **kwargs):
    ...
    if not "tesseract_collision" in os.environ["AMENT_PREFIX_PATH"]:
        ...
        head, tail = os.path.split(get_package_prefix('fanuc_m20ia_support'))
    ...
    urdf = os.path.join(get_package_share_directory('fanuc_m20ia_support'), 'urdf', 'm20ia.urdf')
    print(urdf)
    ...
    gazebo_model_path = os.path.join(os.environ['HOME'],'.gazebo', 'models', 'fanuc_m20ia_support')
    crs_model_path = get_package_share_directory('fanuc_m20ia_support')
...
def generate_launch_description():
    ...
    return launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument('xacro',
            default_value = [os.path.join(get_package_share_directory('fanuc_m20ia_support'), 'urdf', 'm20ia.xacro')]),
        launch.actions.DeclareLaunchArgument('srdf',
            default_value = [os.path.join(get_package_share_directory('fanuc_m20ia_support'), 'urdf', 'fanuc_m20ia.srdf')]),
        ...
        launch.actions.DeclareLaunchArgument('urdf_preview_path', 
             default_value = [os.path.join(get_package_share_directory('fanuc_m20ia_support'), 'urdf', 'm20ia.urdf')],
