...
def launch_setup(context, *args, **kwargs):
    ...
    if not "tesseract_collision" in os.environ["AMENT_PREFIX_PATH"]:
        ...
        head, tail = os.path.split(get_package_prefix('fanuc_m710ic_support'))
    ...
    urdf = os.path.join(get_package_share_directory('fanuc_m710ic_support'), 'urdf', 'm710ic.urdf')
    print(urdf)
    ...
    gazebo_model_path = os.path.join(os.environ['HOME'],'.gazebo', 'models', 'fanuc_m710ic_support')
    crs_model_path = get_package_share_directory('fanuc_m710ic_support')
...
def generate_launch_description():
    ...
    return launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument('xacro',
            default_value = [os.path.join(get_package_share_directory('fanuc_m710ic_support'), 'urdf', 'm710ic50.xacro')]),
        launch.actions.DeclareLaunchArgument('srdf',
            default_value = [os.path.join(get_package_share_directory('fanuc_m710ic_support'), 'urdf', 'fanuc_m710ic50.srdf')]),
        ...
        launch.actions.DeclareLaunchArgument('urdf_preview_path', 
             default_value = [os.path.join(get_package_share_directory('fanuc_m710ic_support'), 'urdf', 'm710ic.urdf')],
