...
def launch_setup(context, *args, **kwargs):
    ...
    if not "tesseract_collision" in os.environ["AMENT_PREFIX_PATH"]:
        ...
        head, tail = os.path.split(get_package_prefix('abb_irb6700_support'))
    ...
    urdf = os.path.join(get_package_share_directory('abb_irb6700_support'), 'urdf', 'irb6700_200_260.urdf')
    print(urdf)
...
def generate_launch_description():
    ...
    return launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument('xacro',
            default_value = [os.path.join(get_package_share_directory('abb_irb6700_support'), 'urdf', 'irb6700_200_260.xacro')]),
        launch.actions.DeclareLaunchArgument('srdf',
            default_value = [os.path.join(get_package_share_directory('abb_irb6700_support'), 'urdf', 'irb6700_200_260.srdf')]),
        ...
        launch.actions.DeclareLaunchArgument('urdf_preview_path', 
             default_value = [os.path.join(get_package_share_directory('abb_irb6700_support'), 'urdf', 'irb6700_200_260.urdf')],
