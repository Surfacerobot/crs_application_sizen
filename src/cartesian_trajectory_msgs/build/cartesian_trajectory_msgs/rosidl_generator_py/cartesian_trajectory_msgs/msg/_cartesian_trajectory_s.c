...
bool cartesian_trajectory_msgs__msg__cartesian_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "cartesian_trajectory_msgs.msg._cartesian_trajectory.CartesianTrajectory",
        full_classname_dest, 71) == 0);
  }
  cartesian_trajectory_msgs__msg__CartesianTrajectory * ros_message = _ros_message;
  {  // header
  ...
  {  // points
    ...
    if (!cartesian_trajectory_msgs__msg__CartesianTrajectoryPoint__Sequence__init(&(ros_message->points), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create cartesian_trajectory_msgs__msg__CartesianTrajectoryPoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    cartesian_trajectory_msgs__msg__CartesianTrajectoryPoint * dest = ros_message->points.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!cartesian_trajectory_msgs__msg__cartesian_trajectory_point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * cartesian_trajectory_msgs__msg__cartesian_trajectory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cartesian_trajectory_msgs.msg._cartesian_trajectory");
  ...
  {  // points
    ...
    cartesian_trajectory_msgs__msg__CartesianTrajectoryPoint * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->points.data[i]);
      PyObject * pyitem = cartesian_trajectory_msgs__msg__cartesian_trajectory_point__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
