...
bool cartesian_trajectory_msgs__msg__cartesian_trajectory_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "cartesian_trajectory_msgs.msg._cartesian_trajectory_point.CartesianTrajectoryPoint",
        full_classname_dest, 82) == 0);
  }
  cartesian_trajectory_msgs__msg__CartesianTrajectoryPoint * ros_message = _ros_message;
  {  // pose
...
PyObject * cartesian_trajectory_msgs__msg__cartesian_trajectory_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cartesian_trajectory_msgs.msg._cartesian_trajectory_point");
