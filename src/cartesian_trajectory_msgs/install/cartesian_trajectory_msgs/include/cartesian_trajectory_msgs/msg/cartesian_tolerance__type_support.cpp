...
{
  new (message_memory) cartesian_trajectory_msgs::msg::CartesianTolerance(_init);
}

void CartesianTolerance_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cartesian_trajectory_msgs::msg::CartesianTolerance *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CartesianTolerance_message_member_array[4] = {
  {
    ...
    offsetof(cartesian_trajectory_msgs::msg::CartesianTolerance, position_error),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cartesian_trajectory_msgs::msg::CartesianTolerance, orientation_error),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cartesian_trajectory_msgs::msg::CartesianTolerance, twist_error),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cartesian_trajectory_msgs::msg::CartesianTolerance, wrench_error),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CartesianTolerance_message_members = {
  ...
  4,  // number of fields
  sizeof(cartesian_trajectory_msgs::msg::CartesianTolerance),
...
{
  return &::cartesian_trajectory_msgs::msg::rosidl_typesupport_introspection_cpp::CartesianTolerance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cartesian_trajectory_msgs, msg, CartesianTolerance)() {
  return &::cartesian_trajectory_msgs::msg::rosidl_typesupport_introspection_cpp::CartesianTolerance_message_type_support_handle;
}
